...
import { Text, View, TouchableOpacity, TextInput, StyleSheet, ScrollView, Dimensions, KeyboardAvoidingView, ActivityIndicator, 
    Platform, LogBox } from 'react-native';
            ...
            {loading ? (
                ...
                <View style={styles.avatarContainer}>
                    {!editing ? (
                        ...
                        <SvgXml
                            xml={createAvatar(identicon, { seed: selectedAvatar }).toString()}
                            width={50}
                            height={50}
                        />
                    </View>
                ...
                <View style={styles.avatarContainer}>
                    ...
                    <Text>Username:</Text>
                    <TextInput
                        style={[styles.input, editing ? styles.inputEditable : styles.inputNonEditable]}
                        editable={editing}
                        value={username}
                    ...
                    <Text>Bio:</Text>
                    <TextInput
                        style={[styles.input_bio, editing ? styles.inputEditable : styles.inputNonEditable]}
                        editable={editing}
                        value={bio}
                        multiline={true}
                        numberOfLines={4}
                    ...
                    {editing ? (
                        ...
                        <View style={[styles.inputNonEditable, { padding:10, width: "80%", alignSelf:"center"}]}>
